Feature: create panel
  ...
  Scenario: completed
    Given no panel with id "panel1" exists in the current workspace
    When I try to create a panel with id "panel1"
    Then the panel with id "panel1" is created
    And I can lookup the panel with id "panel1" in the current workspace
  ...
  Scenario: abandoned - panel already exists
    ...
    And a panel with id "panel1" exists in the current workspace
    When I try to create a panel with id "panel1"
